...
const INITIAL_PROJECTS = [
  {
    ...
    assets: [
      ...
      { id: "asset-rep-1", name: "Republic Pattaya 60 FPS Teaser", type: "video", isPrimary: false, url: "/media/republic-pattaya-teaser-mobile-h265.mp4", poster: "/media/Underground1.jpg" },
  ...
  },
  {
    ...
    official_links: [
      { label: "CBS Pittsburgh Exhibition Feature", url: "https://www.cbsnews.com/pittsburgh/news/immersive-van-gogh-exhibit-opens-in-pittsburgh/", badge: "Broadcast Feature" },
      { label: "Lighthouse Immersive Exhibition Portal", url: "https://www.immersivevangogh.com/", badge: "Exhibition Portal" }
    ],
    assets: [
      { id: "asset-vg-1", name: "Van Gogh 360° 60 FPS Teaser", type: "video", isPrimary: true, url: "/media/vangogh-360-teaser-mobile-h265.mp4", poster: "/media/Artechouse4.jpg" },
      { id: "asset-vg-press", name: "CBS Pittsburgh Video Feature", type: "link", isPrimary: false, url: "https://www.cbsnews.com/pittsburgh/news/immersive-van-gogh-exhibit-opens-in-pittsburgh/" },
              ...
              {(() => {
                ...
                return hero && isLocalVideo(hero.url) ? (
                  <video
                    ...
                    style={{ width: '100%', aspectRatio: '16 / 9', objectFit: 'cover', borderRadius: '6px', border: '1px solid #334155', marginBottom: '10px', display: 'block', cursor: 'zoom-in' }}
                  />
                ) : hero ? (
                  <img
                    src={hero.url}
